...
For potential Bonsai **user**, open data on BONSAI can be accessed from [the Open Virtuoso triplestore](https:// http://odas.aau.dk/). Accessing data from the Jena requires [SPARQL](https://www.w3.org/TR/rdf-sparql-query/) know-how. Development of easy to use tools is currently ongoing.
